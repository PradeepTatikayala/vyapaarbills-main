...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "support@vyapaarbills.com")
SUPPORT_EMAIL = os.getenv("SUPPORT_EMAIL", "vyapaarbills@gmail.com")
